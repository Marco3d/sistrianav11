...
<!-- Comienzo del Contenido Dinamico-->
            ...
            <div class="row">
                                <div class="col-lg-12">
                                    <h3> Modificar documentos proyectos</h3>
                            ...
                            <div class="row">
                             ...
                             <div>
                                ...
                                <input type="submit" <button class="btn btn-success" type="button" name="actualizar" value="Actualizar" title="Actualizar">
                                 <a class="btn btn-default" href="<?php echo Principal::ruta(); ?>/sisdocentes/docproyectos.php" role="button">Cancelar</a>
                                ...
                                # code...
                                  ...
                                  <a class="btn btn-default" href="<?php echo Principal::ruta(); ?>/sisdocentes/docproyectos.php" role="button">Regresar</a>
