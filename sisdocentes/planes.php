                                               ...
                                               <?php if ($key["idcategoria"] == 1) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <a href="planes/modificar.php?id=<?php echo $key['id_archivos']; ?>" title="Editar">
                                                            <i class="fa fa-pencil-square-o"></i></a> 

                                                            <?php if ($key["nombre_docentes"]== $_SESSION["nombre_docentes"]) {?>
                                                                <a href="javascript:void(0);" onclick="eliminiar('planes/delete.php','<?php echo $key["id_archivos"]; ?>')">
