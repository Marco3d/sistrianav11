...
<!-- Comienzo del Contenido Dinamico-->
       ...
       <div> <?php include 'includes/mensajes.php' ?></div>
                                            ...
                                            <?php foreach ($datos2 as $key) { ?>
                                               ...
                                               <?php if ($key["idcategoria"] == 2) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center"><a href="<?php echo Principal::ruta(); ?>/sisdocentes/evainst/docevainst/<?php echo $key["archivo"]; ?>"><?php echo $key["archivo"]; ?></a></td>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <a href="evainst/modificar.php?id=<?php echo $key['id_archivos']; ?>" title="Editar">
                                                            <i class="fa fa-pencil-square-o"></i></a> 

                                                            <?php if ($key["nombre_docentes"]== $_SESSION["nombre_docentes"]) {?>
                                                                <a href="javascript:void(0);" onclick="eliminiar('evainst/delete.php','<?php echo $key["id_archivos"]; ?>')">
                        ...
                        ?>
                        <a href="evainst/insertar.php" class="btn btn-default btn-lg active" role="button">Agregar evaluación institucional</a> 
