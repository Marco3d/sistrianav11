                            ...
                            <div class="row">
                             ...
                             <div>
                                ...
                                <input type="submit" <button class="btn btn-success" type="button" name="actualizar" value="Actualizar" title="Actualizar">
                                 <a class="btn btn-default" href="<?php echo Principal::ruta(); ?>/sisdocentes/actas.php" role="button">Cancelar</a>
                                ...
                                # code...
                                  ...
                                  <a class="btn btn-default" href="<?php echo Principal::ruta(); ?>/sisdocentes/actas.php" role="button">Regresar</a>
