<?php session_start();
 require_once 'class/subactas.php';
  if (isset($_SESSION["iddocentes"]) and isset($_SESSION["usudocente"])) {
    ...
    $registros = new Subactas();
    $datos = $registros->get();
   //echo "<pre>";print_r($datos);
    
    $registros_docentes = new Subactas();
...
<!-- Comienzo del Contenido Dinamico-->
		   ...
		   <div> <?php include 'includes/mensajes.php' ?></div>
                                            ...
                                            <?php foreach ($datos2 as $key) { ?>
                                               ...
                                               <?php if ($key["idcategoria"] == 5) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center"><a href="<?php echo Principal::ruta(); ?>/sisdocentes/actas/misactas/<?php echo $key["archivo"]; ?>"><?php echo $key["archivo"]; ?></a></td>
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <a href="actas/modificar.php?id=<?php echo $key['id_archivos']; ?>" title="Editar">
                                                            <i class="fa fa-pencil-square-o"></i></a> 

                                                            <?php if ($key["nombre_docentes"]== $_SESSION["nombre_docentes"]) {?>
                                                                <a href="javascript:void(0);" onclick="eliminiar('actas/delete.php','<?php echo $key["id_archivos"]; ?>')">
                        ...
                        ?>
                        <a href="actas/insertar.php" class="btn btn-default btn-lg active" role="button">Agregar actas</a> 
